jQuery("document").ready(function()
{
	...
	jQuery("#gallery a").click(function(){
        ...
        //si no es indefinida
            ...
            //hacemos un efecto llamado fadeout para que desaparezca todo lo que está dentro del big-image
            jQuery("#big-image").fadeOut(function(){

                //dentro del div big-image sustituimos el html y lo reconstruimos con los datos de las variables recibidas. Si no hacemos esto, aunque la imagen grande se sustituirá, el zoom, se quedará con la primera imagen.
                jQuery("#big-image").html('<img id="zoom_03" class="img-responsive" src="'+dataimagen+'" data-zoom-image="'+ dataimagenzoom+'"/>');

                //ejecutamos el elevatezoom a la imagen que tiene el id zoom_03.
                //jQuery("#zoom_03").elevateZoom();

                //realizamos un fadein para que aparezca todo lo que está dentro del id big-image
                jQuery("#big-image").fadeIn();
